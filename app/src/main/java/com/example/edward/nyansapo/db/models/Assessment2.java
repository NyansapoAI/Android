...
public class Assessment2 implements Parcelable {
    ...
    public Assessment2(String STUDENT_ID, String ASSESSMENT_KEY, String LETTERS_CORRECT, String LETTERS_WRONG, String WORDS_CORRECT, String WORDS_WRONG, String PARAGRAPH_WORDS_WRONG, String STORY_WORDS_WRONG ,String STORY_ANS_Q1, String STORY_ANS_Q2, String LEARNING_LEVEL, String TIMESTAMP, String LOCAL_ID, String CLOUD_ID) {
    ...
    protected Assessment2(Parcel in) {
    ...
    public static final Creator<Assessment2> CREATOR = new Creator<Assessment2>() {
        @Override
        public Assessment2 createFromParcel(Parcel in) {
            return new Assessment2(in);
        }

        @Override
        public Assessment2[] newArray(int size) {
            return new Assessment2[size];
        }
    };
