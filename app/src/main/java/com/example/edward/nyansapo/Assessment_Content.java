...
//Assessment 6
    ...
    public static String[] l6  = {"d", "j", "p", "e", "r", "u", "h", "f", "c", "s"};
    public static String[] w6 = {"egg", "sun", "duck", "bush", "mat", "food", "doll", "pig", "vest", "sheep"};
    public static String[] p6 = {"Musa is a brother to Maria. He is in class two. His sister is in class three. They are good friends.", "Father has built a beautiful house. It is very big. We like it a lot. We will move in today."};
    public static String s6 = "Ali lives near Lake Turkana. He has a wife and four children. All his children go to school. He works very hard to keep them in school. He gives them all they need. The children work hard in school. Ali has a boat and many fishing nets. Everyday he goes fishing in the lake. He wakes up very early to set his nets. His friend James goes with him. The two catch a lot of fish. They sell most of the fish in the market. They then take the rest to their homes. Their families like the fish very much.";
    public static String[] q6 = {"How many children does Ali have?", "What do we learn about Lake Turkana from the story?"};



//Assessment 7

public static String[] l7  = {"c", "u", "v", "j", "g", "b", "z", "t", "o", "w"};
public static String[] w7 = {"sock", "milk", "dad", "pin", "book", "home", "ear", "bag", "seven", "lion"};
public static String[] p7 = {"My mother is a nurse. She works in a big hospital. She looks after sick people. She likes her work.", "Last week we visited a farm. There were many workers. We saw many crops. We will plant some in school."};
public static String s7 = "Long time ago hare and hyena were friends. They lived in the same village. The hare was a good dancer. He always called hyena to come see him dance. The hyena liked the way hare danced. He tried the dance at his home. He became a good dancer too. One day all the animals went for a dance. They wanted to see who was the best dancer. They all danced very well. Hare and hyena danced better than the rest. Hare knew he would win. The animals were asked to name the winner. Most of them clapped for the hyena. The hare was very sad.";
public static String[] q7 = {"Why did the hare always invite the hyena to his home?", "Why was the hare not happy after the dance?"};


//Assessment 8

public static String[] l8  = {"i", "d", "p", "c", "f", "k", "m", "z", "a", "r"};
public static String[] w8 = {"boy", "dock", "ship", "leg", "foot", "ball", "rat", "jug", "class", "face"};
public static String[] p8 = {"Our school has many trees. There is one big mango tree. The tree is behind the office. It gives us many fruits", "We have a dog at home. She has a puppy. She gave birth to it yesterday. I named the puppy Rambo."};
public static String s8 = "Long ago there lived a hyena and a dog. They lived in the middle of the forest. The two were close friends. The dog was very hardworking and brave. He planted all types of fruits. Hyena on the other hand was lazy. He kept stealing the fruits from the farm. The dog was very unhappy one day. He decided to lay a trap. He wanted to teach the thief a lesson. He dug a big hole in his farm. He covered the hole with leaves. Hyena came to steal and fell in the hole. He broke two of his legs. That is why hyena limps to this day.";
public static String[] q8 = {"Where did the hyena and the dog live?", "Why did the hyena fall into the hole?"};


//Assessment 9

public static String[] l9  = {"e", "x", "d", "w", "k", "c", "h", "b", "j", "a"};
public static String[] w9 = {"room", "face", "table", "dog", "desk", "pen", "ear", "fish", "bean", "man"};
public static String[] p9 = {"My mother works in Lamu. Lamu is a busy town. The people there are good. They are very kind.", "Our village shop is big. It is near the road. Omari is the shopkeeper. He sells sugar and milk."};
public static String s9 = "Juma reads to us a story from his book everyday. He reads the story aloud in class. We enjoy listening to the stories. Yesterday he read about the sun and the wind. Both of them lived in the same sky. The wind did not like the sun. It wanted to be the head of the sky. One day the wind chased the sun away. It told the sun to go to another sky. The sun did not go. The next morning the wind ran after the sun. The sun fell down and started crying. That is how it began to rain. We clapped for Juma.";
public static String[] q9 = {"What does Juma do every day?", "How did the rain begin?"};
...
public static String[] q10 = {"What are farmers waiting for?", "Why does Maria want to plant trees?"};
  ...
  public static String[] getL8() {
    return l8;
  }

  public static String[] getW8() {
    return w8;
  }
  ...
  public static String[] getQ8() {
    return q8;
  }

  public static String[] getL9() {
    return l9;
  }

  public static String[] getW9() {
    return w9;
  }
  ...
  public static String[] getQ9() {
    return q9;
  }

  public static String[] getL10() {
    return l10;
  }
