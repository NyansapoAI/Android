...
import com.nyansapo.presentation.utils.GlobalData
...
class story_assessment : AppCompatActivity() {
    ...
    private fun startVoiceRecording() {
        ...
        if (status.equals("mounted")) {
            ...
            val directory = File(Environment.getExternalStorageDirectory().absolutePath + "/nyansapo_recording/storys/${student!!.firstname}")
            directory.mkdirs()
